<template>
  <div class="index-container">
    ...
    <!--顶部图片-->
    <HeadPhoto id="header-photo" :class="{'m-display-none':focusMode}" class="head-photo" v-if="$route.name==='Home'"
               @fatherMethod="fatherMethod"></HeadPhoto>
...
.index-container {
 ...
 /*  background-image: url("https://cdn.jsdelivr.net/gh/yubifeng/blog-resource/bloghosting/2021/04/23/first87.png") !important;; */
  background-image: url("../assets/first87.png") !important;;
