  ...
  <div class="ui top segment" style="text-align: center">
    ...
    <div v-if="pageShow" class="home-page">
      <el-pagination
        ...
        @current-change="getBlogsByCategoryName"
      >
      </el-pagination>
    </div>
  </div>
...
export default {
  ...
  methods: {
    getBlogsByCategoryName(currentPage) {
      const _this = this;

      this.$axios
        .get(
          "/getBlogsByTypeName?pageNum=" +
            currentPage +
            "&typeName=" +
            this.categoryName
        )
