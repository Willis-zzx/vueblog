<template>
  <div class="head-photo" style="width: 100%; height: 800px">
    <!-- <img src="https://cdn.jsdelivr.net/gh/yubifeng/blog-resource/bloghosting/2021/04/27/340911.jpg"
         style="width: 100%;height: 100%"> -->
    <img src="../assets/340911.jpg" style="width: 100%; height: 100%" />
...
export default {
  ...
  method() {
    let str =
      "这是我的个人博客、会分享关于编程、开发的一些内容，以后也会写一些随笔，希望可以对您有所帮助...";
    let idx = 0;
    let that = this;
    ...
    var waypoint = new Waypoint({
      ...
      handler: function (direction) {
        if (document.getElementById("waypoint") !== null) {
          if (
            document.getElementById("header-photo").style.display !== "none"
          ) {
            if (direction === "down") {
              $("#nav").show(500);
            } else {
