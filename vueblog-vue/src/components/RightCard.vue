<template>
  <div class="card">
    ...
    <p style="margin-top: 0px;">Welcome to Skymo's Blog</p>
    <div>
      <p style="margin-left: 20px; margin-top:40px;margin-bottom:0px;font-size: 16px;font-family: 宋体;font-weight: bold;">
        我们一日日度过的所谓的日常，</p>
